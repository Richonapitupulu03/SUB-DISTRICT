...
<div class="wrapper row3">
  <div class="rounded">
    <main class="container clear"> 
      ...
      <div id="gallery">
        <figure>
          <header class="heading" style="color: red;">STRUKTUR PEMERINTAHAN KECAMATAN MEDAN PERJUANGAN</header>
          <p style="color: black;">Pada Saat sekarang ini Kantor Camat Pancur Batu terdiri dari 25 (dua puluh lima) desa/kelurahan dan 116 (seratus enam belas) lingkungan, berikut merupakan struktur pemerintahan pada kantor camat Pancur Batu:</p>
          <br>
         <center><img src="../images/pancurbatu/strukturorganisasi.png" style="width:900px;height:800px;"></center>
      </div>
    </main>
  </div>
</div>
