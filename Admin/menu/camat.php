...
<?php include "header.php"; ?>
  ...
  <div class="home-content">
    <center><h1>Data Camat & Periode Jabatan</h1></center>
...
?>
        ...
        while($data = mysqli_fetch_array($data_berita)){
          ?>
            <tr>
                ...
                <td width="80px">
                <center>
                  <a href="update_camat.php?id_camat=<?php echo htmlspecialchars($data['id_camat']); ?>" class="btn btn-warning" role="button">Update</a>
                </center>
                </td> 

                <td width="80px">
                <center> <a href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>?id_camat=<?php echo $data['id_camat']; ?>" class="btn btn-danger" role="button">Delete</a> </center>
                </td>
            </tr>
            </tbody>
            <?php
    ...
    <nav>
    <a href="tambah_camat.php" class="btn btn-primary" role="button">Tambah Data</a>
