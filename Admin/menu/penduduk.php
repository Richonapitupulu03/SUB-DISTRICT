...
<?php include "header.php"; ?>
  ...
  <div class="home-content">
    ...
    <br>
    <a href="penduduk.php"><button style="margin-left: 82px; border-radius: 10px;" class="btn-danger"> 
    <h5>Berdasarkan Agama</h5></button></a>

    <a href="berd_pendidikan.php"><button style="margin-left: 82px; border-radius: 10px;"> 
    ...
    <table class="table table-bordered table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td width="15px"><?php echo $data["kelurahan"]; ?></td>
                <td width="80px"><?php echo $data["islam"]; ?></td>
                <td width="80px"><?php echo $data["kristen"]; ?></td>
                <td width="80px"><?php echo $data["khatolik"]; ?></td>
                <td width="80px"><?php echo $data["hindu"]; ?></td>
                <td width="80px"><?php echo $data["budha"]; ?></td>
                <td width="80px"><?php echo $data["konghuchu"]; ?></td>
                <td width="80px">
