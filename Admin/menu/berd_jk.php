...
<?php include "header.php"; ?>
  ...
  <div class="home-content">
    ...
    <a href="berd_jk.php"><button style="margin-left: 82px; border-radius: 10px;" class="btn-danger"> 
    ...
    <table class="table table-bordered table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td width="80px"><?php echo $data["laki_laki"]; ?></td>
                <td width="80px"><?php echo $data["perempuan"]; ?></td>
                <td width="80px">
