...
<?php include "header.php"; ?>
  ...
  <div class="home-content">
    ...
    <a href="berd_perpindahan.php"><button style="margin-left: 82px; border-radius: 10px;" class="btn-danger"> 
    ...
    if (isset($_GET['id_pddk'])) {
        ...
        //Kondisi apakah berhasil atau tidak
            if ($hasil) {
                header("Location:berd_perpindahan.php");
    ...
    <table class="table table-bordered table-hover">
        ...
        <tr style="background-color: aqua;">
            <th>No</th>
            <th>Kelurahan</th>
            <th>Keluar-Masuk<br><small>antar kecamatan</small></th>
            <th>Keluar-Masuk<br><small>antar kelurahan</small></th>
        ...
        <tbody>
            ...
            <tr>
               ...
               <td width="15px"><?php echo $data["kelurahan"]; ?></td>
                <td width="80px"><?php echo $data["antar_kec"]; ?></td>
                <td width="80px"><?php echo $data["antar_kel"]; ?></td>
